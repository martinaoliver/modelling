    ...
    for parID,ss in df.index:
        ...
        try:
            if simulateGrowth == False:
                ...
                query = insert_simulationOutput_to_sql(simulation_param_dict, model_param_dict,U_final_1D,U_record_1D, dimensions='1D')
