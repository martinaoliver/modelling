...
folder = 'turinghill_variant5_nogrowth'
...
def numerical_check(df,circuit_n, variant = variant, n_species=n_species, test = False):
    ...
    for parID,ss in df.index:
        ...
        try:
            ...
            mechanism = 'nogrowth'
            U_final,U_record, U0, x_grid, reduced_t_grid= cn_nogrowth(par_dict,L,J,T,N, circuit_n, tqdm_disable=tqdm_disable, record_every_x_hours = 100)
