...
#solver parameters
L=10; x_gridpoints=1; J=L*x_gridpoints
T=10; t_gridpoints = 10; N=T*t_gridpoints #Number of timepoints
dx = float(L)/float(J)

#run
U,U_record, U0, x_grid, reduced_t_grid= cn_edgegrowth2(par_dict,L,J,T,N, circuit_n)
