...
print('Turing robustness',np.sum(df['weightTuring'])/nsamples)

pkl.dump(df, open(modellingpath + '/3954/paper/out/analytical/lsa_dataframes/all_dataframes/lsa_df_%s_variant%s_%rparametersets_notBalanced_weightTuring.pkl'%(circuit_n,variant,n_param_sets), "wb"))
# %%
