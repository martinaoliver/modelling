...
from colonyMaskCreation_twogrowthrates import *
#%%
#############
###execution parameters#####
#############
# %matplotlib inline
shape = 'caTwoGrowthRates'
...
T =60; dt = 0.02; N = int(T/dt)
# T =3; dt = 0.5; N = int(T/dt)
boundarycoeff = 1
divisionTimeHours=0.5
p_division=[1,0.5];seed=1
...
try:
    ...
    cell_matrix_record, memory_matrix_record, daughterToMotherDictList = maskFunction_twogrowthrates(L=L,dx=dx, T=T, dt=dt, divisionTimeHours=divisionTimeHours, p_division=p_division, plot1D=True, plotScatter=True)
