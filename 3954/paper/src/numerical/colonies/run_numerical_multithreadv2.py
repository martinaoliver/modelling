...
# with open(modellingpath + '/3954/paper/out/analytical/lsa_dataframes/turing_dataframes/turing_df_circuit%s_variant%s_%sparametersets.pkl'%(circuit_n,variant,nsamples), "rb" ) as f:
    df = pickle.load(f)
