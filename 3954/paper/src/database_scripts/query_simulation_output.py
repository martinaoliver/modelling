...
circuit_n=14
#  circuit_n='circuit14'
variant='2nd' #f'fitted7_gaussian4187715_nsr{0.01}'#'2nd' #variant='fitted7'
balance='Balanced'
Kce=100
n_samples = 1000000#2000#1000000 #n_samples = 13700000
...
# %%
time=85
plot_redgreen_contrast(U_record[:][:,:,:,time],L,parID=6 ,save_figure=True, path=saveFigPath, filename=filename(parID)+('_time%r'%time))
