...
var=float(sys.argv[8])
folder = 'fullcircuit_5716gaussian/var%s'%var
n_species = 6
# Specifiy number of parameter sets in parameterset file to be loaded
n_param_sets = 1000 #var
# n_param_sets = 1417 #1M_turing
    ...
    for parID in df_index:
     ...
     # Define 2D numerical parameters
        ...
        try:
            ...
            # pickle.dump(U_record,open(modelling_ephemeral + '/3954/numerical_confocal/results/simulation/square/%s/2Dfinal_%s.pkl'%(folder,filename), 'wb'))
            # print(modelling_home + '/3954/numerical_confocal/results/simulation/square/%s/2Dfinal_%s.pkl'%(folder,filename))
...
# df= pickle.load( open(modelling_home + '/3954/parameter_space_search/results/turing_dataframes/turing_lsa_df_circuit2_variant0_1000000parametersets.pkl', "rb" ) )
