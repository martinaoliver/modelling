...
# fig.subplots_adjust(hspace=-0.6,wspace = -0.1)
    plt.tight_layout()
    plt.savefig('peakresults/figures/stripped/nonturingstripped_parID%r'%parID)
    plt.close()
    plt.clf()
...
# fig.subplots_adjust(hspace=-0.6,wspace = -0.1)
    plt.tight_layout()
    plt.savefig('peakresults/figures/nonstripped/nonturingnonstripped_parID%r'%parID)
    plt.close()
