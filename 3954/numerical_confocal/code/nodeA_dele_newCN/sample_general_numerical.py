...
# try:
U_record,U_final = adi_ca(par_dict,L_x,L_y,J,I,T,N, circuit_n,n_species,D, tqdm_disable=tqdm_disable, p_division=p_division, stochasticity=1)#,p_division=p_division,seed=seed)
