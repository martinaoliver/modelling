...
U_record = pickle.load( open( modelling_ephemeral + '/3954/numerical_confocal/results/simulation/1M_colony_%s/2D/nodeA_dele_stochastic/2Dtimeseries_%s.pkl'%(shape,filename), "rb" ) )
U_final = pickle.load( open( modelling_ephemeral + '/3954/numerical_confocal/results/simulation/1M_colony_%s/2D/nodeA_dele_stochastic/2Dfinal_%s.pkl'%(shape,filename), "rb" ) )
print('g')
#
