...
parID_list = pickle.load( open(modelling_ephemeral + '/3954/numerical_confocal/results/simulation/1M_colony_ca/2D/nodeA_dele_receptor/parID_list_var7_8x10T120.pkl', "rb" ) )
...
for count,n in enumerate(parID_list):
    ...
    final_concentration = pickle.load( open(modelling_ephemeral + '/3954/numerical_confocal/results/simulation/1M_colony_ca/2D/nodeA_dele_receptor/2Dfinal_%s.pkl'%filename, 'rb' ) )
