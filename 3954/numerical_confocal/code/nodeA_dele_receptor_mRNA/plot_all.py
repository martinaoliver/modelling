...
parID_list = pickle.load( open(modelling_ephemeral + '/3954/numerical_confocal/results/simulation/1M_colony_ca/2D/nodeA_dele_receptor_mRNA/parID_list_variant8_10x15T120N1200.pkl', "rb" ) )
...
for count,n in tqdm(enumerate(parID_list),disable=True):
    ...
    final_concentration = pickle.load( open(modelling_ephemeral + '/3954/numerical_confocal/results/simulation/1M_colony_ca/2D/nodeA_dele_receptor_mRNA/2Dfinal_%s.pkl'%filename, 'rb' ) )
