...
par_dict = {}
symbol_par_dict = {}
general_df = pickle.load(open(modellingpath + '/3954/paper/input/parameterfiles/df_circuit12_variant0_1000parametersets.pkl', "rb"))
...
functions = Matrix([eq.dUdt_f([U,V,A,B,C,D,E,F,aTc],wvn), eq.dVdt_f([U,V,A,B,C,D,E,F,aTc],wvn), eq.dAdt_f([U,V,A,B,C,D,E,F,aTc]), eq.dBdt_f([U,V,A,B,C,D,E,F,aTc]), eq.dCdt_f([U,V,A,B,C,D,E,F,aTc]), eq.dDdt_f([U,V,A,B,C,D,E,F,aTc]), eq.dEdt_f([U,V,A,B,C,D,E,F,aTc]), eq.dFdt_f([U,V,A,B,C,D,E,F,aTc]), eq.daTcdt_f([U,V,A,B,C,D,E,F,aTc])])
